 ...
 */
- (void)setACConnectionStatusChangeDelegate:(id<ACConnectionStatusChangeDelegate>)delegate __attribute__((deprecated("Use -addConnectionStatusChangeDelegate: instead")));
...
/*!
 ...
 @remarks 功能设置
 */
- (void)setReceiveMessageDelegate:(id<ACIMClientReceiveMessageDelegate>)delegate object:(nullable id)userData __attribute__((deprecated("Use -addConnectionStatusChangeDelegate: instead")));;
